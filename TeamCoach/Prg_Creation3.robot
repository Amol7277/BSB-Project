...
TeamCoach Program Creation
    ...
    Division 1 Advance setting      ${EarlyBirth_Date}
    ...
    ...     ${Div1_seasonend}   ${Div1_oldage}      ${Div1_youngdate}
    Division 2 Advance Settings     ${LateFee_Date}
...
#Gender selection
    ...
    sleep       1
    double click element                         (//div/input[@formcontrolname='openDateCtrl'])[1]
    sleep       1

    input text                                   (//div/input[@formcontrolname='closeDateCtrl'])[1]      ${Div1_regi_closedate}
    sleep       1
    double click element                         (//div/input[@formcontrolname='closeDateCtrl'])[1]
    sleep       1

    input text                                   (//div/input[@formcontrolname='startDateCtrl'])[1]      ${Div_seasonstart}
    sleep       1
    double click element                         (//div/input[@formcontrolname='startDateCtrl'])[1]
    sleep       1

    input text                                   (//div/input[@formcontrolname='endDateCtrl'])[1]      ${Div_seasonend}
    double click element                         (//div/input[@formcontrolname='endDateCtrl'])[1]
    sleep   1
